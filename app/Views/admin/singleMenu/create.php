...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="col-lg-8">
            <form action="<?= base_url('single-menu/save'); ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>

                <div class="mb-3">
                    <label for="single_menu" class="form-label">Single Menu</label>
                    <input type="text" class="form-control <?= (session('errors.single_menu')) ? 'is-invalid' : '' ?>" id="single_menu" name="single_menu" value="<?= old('single_menu') ?>" autofocus>
