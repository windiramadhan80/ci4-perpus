        ...
        <div class="col-lg-8">
            <form action="<?= base_url('slider/save'); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= (session('errors.sub_judul')) ? 'is-invalid' : '' ?>" id="sub_judul" name="sub_judul" value="<?= old('sub_judul') ?>">
                    <div class="invalid-feedback">
                ...
                <img src="<?= base_url('img/sliders/default.jpg'); ?>" class="img-preview img-thumbnail my-2" width="120px">
                <div class="mb-3">
